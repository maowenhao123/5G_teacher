//
//  SJFilmEditingInGIFRecordingsControlLayer.m
//  SJVideoPlayer
//
...
@implementation SJFilmEditingInGIFRecordingsControlLayer
...
- (void)_addItemToBottomAdapter {
    ...
    _countDownView = [[SJFilmEditingGIFCountDownView alloc] initWithFrame:CGRectZero];
